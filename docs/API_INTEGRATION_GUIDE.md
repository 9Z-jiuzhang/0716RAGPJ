...
> 版本：与产品 `APP_VERSION`（当前 **2.1.12**）对齐；开发中能力见 `docs/DEV_STATUS.md`  
...
| `citations` | 引用来源列表 | `citations`：文档名、分段、相关度；`images[]` 为命中相关 **PDF 页**缩略图 URL（`/qa/documents/{doc_id}/charts/page-NN.png`，非整本 PDF） |
